...
Warm up:
    ...
    2. write a return method that accepts two parameter Strings a and b, and returns the total numbers of
     apperence of b in String a
    ...
    4. write a return method that can find the maximum number from an Integer arrayList   (DO NOT use sort
        methods of Collections class)
        
    5. write a return method that can find the minimum number from an Integer arrayList     (DO NOT use
        sort methods of Collections class)
...
Constructor: it's a very special method, used for creating the object of the class
      ...
      will give the deafult (no-arg) constructor
