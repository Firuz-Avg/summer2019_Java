...
public class StringMethods_Boolean {
	...
	*/
		...
		/*
		equals(str): check if the two String' visible text are
		...
		*/
		...
		/*
		   ...
		   equalIgnoreCase(str): check if the two String' visible text are
		 equal or not, then returns boolean expression
		...
		*/
		...
		/*
		   contains(str): check if the str is contained in the String
		...
		*/
		...
		/*
		startsWith(str): check if the String is started with 
		the str ornot, then returns boolean expressions
		
		startwith ==> true    !startwith ==> false
