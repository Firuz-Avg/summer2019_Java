...
public class Concatenation {
	...
	Concantenation: combining , Linkin things together ==> creats a String value
	...
	*/
	...
	//	System.out.println("1"+1-3);   // "11"-3
		...
		System.out.println(1+ ( "1"+2 ));   // 112    1 + "12" =>112    
	...
	//	System.out.println( (1+2) - "3");
		...
		System.out.println( "3" + '3');
		//                   "3" + 3
		   // if we cannot char to String, char is concated as character
		//                   "3" + 3
