...
public class ArraysReview_MultiDimensional {
	...
	*/
	...
	public static void main(String[] args) {
		...
		// Arrays.deepToString(variable name): converts multi dimensional arrays to String
		...
		String [][] names = { {"Erhan", "Holy","Denis","John-Snow", "Tarzan"},{"Muhtar", "Mike", "Ariya", "Dilyara", "Nadira"} };
		   //                             0                          1
