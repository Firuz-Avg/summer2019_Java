...
class A {
	...
	public void mm () {
	//	super.name1 = "Hakan"; // super keywordnMust be used in sub class
	}
...
public class Inheritance extends B {
	...
	//	System.out.println(obj2.name2);  // super class cannot inherit anything from sub class
	//	System.out.println(obj2.name3);  // super class cannot inherit anything from sub class
	//	System.out.println(obj2.name4);  // super class cannot inherit anything from sub class
	//	System.out.println(obj2.name5);  // super class cannot inherit anything from sub class
