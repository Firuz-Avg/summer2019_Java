...
public class Quizz {
	...
	public static void main(String[] args) {
		...
		for(char each : characters) {
			...
			if(each == 'b') // after Print does not execute
				continue;  // a b c
		...
		int[] num2 = {1,2,3,4,5};
		   num1 =num2;
		   // num1 = {1,2,3,4,5}; // num1' size has reinitialized
...
//		int numbers[]; // size of the array must be initialized, 
//		     thats why we get compile error
